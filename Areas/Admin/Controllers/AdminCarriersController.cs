...
namespace doan.Areas.Admin.Controllers
{
    ...
    public class AdminCarriersController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var carrier = await _context.Nhavanchuyen
        ...
        public async Task<IActionResult> Create([Bind("MaNvc,TenNvc,DiaChi,Email")] Nhavanchuyen carrier)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var carrier = await _context.Nhavanchuyen.FindAsync(id);
            if (carrier == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaNvc,TenNvc,DiaChi,Email")] Nhavanchuyen carrier)
        {
            if (id != carrier.MaNvc)
            {
                return NotFound();
        ...
        {
            var carrier = await _context.Nhavanchuyen.FindAsync(id);
            _context.Nhavanchuyen.Remove(carrier);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
